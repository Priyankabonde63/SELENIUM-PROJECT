...
public static void main(String[] args) throws InterruptedException {
	...
	for (WebElement d : dash) {
	  if (d.getText().equals("COINS")) {
		...
		a.moveToElement(driver.findElement(By.xpath("(//span[contains(text(),'2 gram')])[2]"))).build()
					.perform();
			driver.findElement(By.xpath("(//span[contains(text(),'2 gram')])[2]")).click();
			break;
		}
	...
	if (title.equals("2 gram 24 KT Lakshmi Gold Coin | BlueStone.com")) {
		...
		System.out.println("FAIL:2 Gram Laxmi Gold coin displayed");
	}
	driver.close();
}
}
